# Changelog (upstream history)

This file preserves the release history of [xingkongliang/skills-manager](https://github.com/xingkongliang/skills-manager)
up to v1.30.0, the point AgentDeck forked from. AgentDeck's own history starts
at 1.0.0 in [`CHANGELOG.md`](CHANGELOG.md); the two version numbers are separate
sequences and do not continue each other.

All notable changes to the upstream project are documented in this file.
