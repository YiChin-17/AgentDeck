# agent-workspace-discovery-roots Specification

## Purpose

TBD - created by archiving change 'support-legacy-codex-skills-in-agent-workspace'. Update Purpose after archive.
...
<!-- @trace
source: support-legacy-codex-skills-in-agent-workspace
updated: 2026-08-09
code:
  - src/i18n/en.json
  - src/i18n/zh-TW.json
