# codex-skill-path-routing Specification

## Purpose

Define how AgentDeck routes Codex Skill deployment and discovery across the modern `.agents/skills` defaults, discovery-only legacy `.codex/skills` roots, user overrides, and equivalent-result deduplication.
...
<!-- @trace
source: adopt-modern-codex-skill-paths
updated: 2026-08-09
code:
  - BASELINE.md
